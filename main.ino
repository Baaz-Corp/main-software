...
void HANDLE_LIDAR(void) {
  ...
  //==================================
  float angleRadFloat = ((angleDegreesFloat + 3) * PI/180);
...
void ROOMBA_SELF_ORIGIN(void) {
  ...
  x_at = line_coefficents_filtered[0].y/sin(line_coefficents_filtered[0].x);
  y_at = -1*line_coefficents_filtered[0].y/cos(line_coefficents_filtered[0].x);
